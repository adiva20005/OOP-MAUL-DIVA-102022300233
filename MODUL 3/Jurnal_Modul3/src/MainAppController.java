...
public class MainAppController {
    ...
    public void initialize() {
        ...
        priorityCol.setCellValueFactory(new PropertyValueFactory<Task, String>("prioritas"));
        statusCol.setCellValueFactory(new PropertyValueFactory<Task, String>("status tugas"));
        dueDateCol.setCellValueFactory(new PropertyValueFactory<Task, LocalDate>("Date"));
    ...
    private void addTask() {
        try {
            ...
            if (titleField.getText().isEmpty() || priorityBox.getValue() == null || dueDatePicker.getValue() == null) {
                ...
                throw new MissingFieldException ("Semual file harus diisi");
            }
    ...
    private void deleteTask() {
        try {
            ...
            if (selected == null) {
                ...
                Throw new TaskNotSelectedException ("Silahkan pilihSSS")
